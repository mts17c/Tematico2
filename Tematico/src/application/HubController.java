...
public class HubController {
    ...
    private void abrirTelaDetalhes() {
        ...
        if (setorSelecionado != null) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("detalhes.fxml"));
                Parent root = loader.load();
                DetalhesSetorController detalhesController = loader.getController();
                detalhesController.setSetor(setorSelecionado);
                
                javafx.stage.Stage stage = new javafx.stage.Stage();
                stage.setScene(new Scene(root));
                stage.setTitle("Detalhes do Setor");
                stage.show();
            } catch (IOException e) {
                e.printStackTrace();
            }
